...
function SidebarContent({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Logo */}
      <div className="px-5 py-4 border-b border-[#1B1F27]">
      ...
      <div className="px-3 py-2 flex-1 overflow-y-auto">
        ...
        {loading ? (
          ...
          <button
            onClick={onNewProject}
            className="w-full text-left px-2 py-2.5 rounded-lg border border-dashed border-[#23272F] text-xs text-zinc-600 hover:text-zinc-400 hover:border-[#2F3541] transition-colors"
          >
          ...
          <div className="space-y-0.5">
            {projects.map((project) => (
              <div key={project.id}>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isProjectActive(project.id)
                      ...
                      : 'text-zinc-300 hover:text-white hover:bg-[#171B23]'
                  )}
                >
                ...
                {expandedProjectId === project.id && (
                  <div className="ml-2 pl-2 border-l border-[#1B1F27] mt-0.5 space-y-0.5">
                        ...
                        <Link
                          ...
                          className={cn(
                            ...
                            active
                              ...
                              : 'text-zinc-400 hover:text-white hover:bg-[#171B23]'
                          )}
                        >
                          <item.icon size={12} />
                          {item.label}
      ...
      {/* Footer utilisateur */}
      <div className="px-3 py-3 border-t border-[#1B1F27]">
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-40 p-2 rounded-lg bg-[#12151C] border border-[#23272F] text-zinc-400"
      >
        <Menu size={18} />
      </button>
      ...
      <aside
        className={cn(
          'lg:hidden fixed inset-y-0 left-0 z-50 w-64 bg-[#0A0D13] border-r border-[#1B1F27] transition-transform duration-200',
      ...
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex flex-col w-56 shrink-0 bg-[#0A0D13] border-r border-[#1B1F27] h-screen sticky top-0">
        <SidebarContent {...contentProps} />
      </aside>
    </>
  )
