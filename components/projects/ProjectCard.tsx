...
export default function ProjectCard({ project, onEdit, onDelete }: ProjectCardProps) {
  ...
  return (
    <div className="group relative rounded-xl border border-zinc-800 bg-zinc-900 p-5 hover:border-zinc-700 transition-all duration-200">
      {/* Header */}
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        <div className="relative">
          <button
            ...
            className="p-1 rounded-lg text-zinc-600 hover:text-zinc-300 hover:bg-zinc-800 transition-colors opacity-0 group-hover:opacity-100"
          >
          ...
          {menuOpen && (
            <>
              ...
              <div className="absolute right-0 top-6 z-20 w-36 rounded-lg border border-zinc-700 bg-zinc-900 shadow-xl py-1">
                <button
      ...
      <Link
        ...
        className="flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-zinc-800 hover:bg-violet-600/20 border border-zinc-700 hover:border-violet-500/50 text-xs font-medium text-zinc-300 hover:text-violet-300 transition-all duration-150"
      >
        <BarChart2 size={12} />
        Ouvrir le tracker
      </Link>
